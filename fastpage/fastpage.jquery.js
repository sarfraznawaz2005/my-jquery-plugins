/**
 * Plugin to load content of pages behind the scene while user is on a page or idle.
 ...
 * $('.someClass').fastpage();
 *
 * container: inside element where ajax response will be placed. If none, document.body will be used.
 */
(function ($) {
